...
dataPath = 'C:/Users/46195270/Desktop/proyecto/Proyecto5to/Data' #Cambia a la ruta donde hayas almacenado Data
...
for nameDir in peopleList:
    ...
    for fileName in os.listdir(personPath):
        ...
        #cv2.waitKey(10)
    label = label + 1 #Cambia la etiqueta cuando cambia de carpeta inscripciones
...
face_recognizer.write('modeloEigenFace1') #1
